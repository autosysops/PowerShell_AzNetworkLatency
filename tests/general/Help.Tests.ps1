...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\AzNetworkLatency\functions", "$global:testroot\..\AzNetworkLatency\internal\functions"),

	[string]
	$ModuleName = "AzNetworkLatency",
...
$CommandPath = @(
    "$global:testroot\..\AzNetworkLatency\functions"
    "$global:testroot\..\AzNetworkLatency\internal\functions"
)
