...
Remove-Module AzNetworkLatency -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\AzNetworkLatency\AzNetworkLatency.psd1"
Import-Module "$PSScriptRoot\..\AzNetworkLatency\AzNetworkLatency.psm1" -Force
